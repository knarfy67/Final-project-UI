    ...
    const handleSubmit = async(event) => {
        ...
        if(password === passwordConfirm ){
          try {
            ...
            const response = await axios.get(`http://localhost:8000/api/staff/reset-password?email=${email}&password=${password}&password_confirmation=${passwordConfirm}&token=${token}`);
